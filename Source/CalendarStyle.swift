...
public class SwipeLabelStyle: NSCopying {
    ...
    public var textFont = UIFont.systemFont(ofSize: 18)
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        ...
        copy.closeHandler = closeHandler
...
public class TimelineStyle: NSCopying {
    ...
    public var timelineDuration = 15
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        ...
        copy.backgroundColor = backgroundColor
        copy.timelineDuration = timelineDuration
        copy.textFont = textFont
        copy.timeFont = timeFont
        return copy
    }
}
